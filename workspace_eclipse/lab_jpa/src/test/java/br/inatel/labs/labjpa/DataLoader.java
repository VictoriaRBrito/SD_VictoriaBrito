...
import br.inatel.labs.labjpa.services.FornecedorService;
import br.inatel.labs.labjpa.services.NotaCompraService;
import br.inatel.labs.labjpa.services.ProdutoService;
...
class DataLoader{
	...
	void load() {
		...
		notaCompraService.listar().forEach( System.out::println );
